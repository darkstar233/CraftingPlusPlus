...
data modify storage cpp:playerbag Items[{id:"minecraft:firework_star",tag:{dict:['head_decor']}}].id set value "minecraft:leather_helmet"
setblock ~ 255 ~ shulker_box
data modify block ~ 255 ~ Items set from storage cpp:playerbag Items
loot replace entity @s hotbar.0 27 mine ~ 255 ~ shears{drop_content:1b}
...
data modify block ~ 255 ~ Items set from storage cpp:playerbag Items
loot replace entity @s inventory.18 9 mine ~ 255 ~ shears{drop_content:1b}
