...
loot replace entity @s weapon.mainhand 1 loot cpp:wandering_trader/potion_id
...
loot replace entity @s weapon.mainhand 1 loot cpp:wandering_trader/potion_duration
