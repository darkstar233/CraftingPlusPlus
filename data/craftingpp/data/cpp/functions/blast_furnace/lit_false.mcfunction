data remove storage cpp:blast_furnace tag
data modify storage cpp:blast_furnace tag merge from block ~ ~ ~ {}
...
data modify block ~ ~ ~ {} merge from storage cpp:blast_furnace tag
